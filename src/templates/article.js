  ...
  return `
    ...
    {{#comments}}
        ...
        {{#author}}
            ...
            {{/author}}
            {{ ^author }}
             <img class="rounded-circle" src="https://avatars.sched.co/8/fc/8757776/avatar.jpg?2a2" width="35">
            <h5 class="mb-0 ml-3">Guest User</h5>
             {{ /author }}  

            </div>
            <p class="text-muted"><span>{{date}}</span></p>
